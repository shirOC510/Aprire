<%-- 
    Document   : checkout
    Created on : 06/12/2019, 12:47:57 PM
    Author     : BRAYAN LIPE
--%>
							...
							<ul class="nav navbar-nav collapse navbar-collapse">
								...
								<li class="dropdown"><a href="#">Tienda<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
										...
										<li><a href="product-details.jsp">Detalles</a></li> 
	...
	<section id="cart_items">
		<div class="container">
			...
			<div class="checkout-options">
				<h3>Nuevo Usuario</h3>
				<p>Checkout Opciones</p>
				<ul class="nav">
					<li>
						<label><input type="checkbox"> Cuenta Registrada</label>
					</li>
					<li>
						<label><input type="checkbox">Checkout como Invitado</label>
					</li>
					<li>
			...
			<div class="register-req">
				<p>Por favor regitrese y verifique para rapidamente para accder a su historial de compra, o use el Checkout como invitado</p>
			</div>
				...
				<div class="row">
					<div class="col-sm-3">
						<div class="shopper-info">
							...
							<a class="btn btn-primary" href="">Obtener citas</a>
							...
							<div class="form-two">
								<form>
									...
									<select>
										...
										<option>Estados Unidos / Washintong DC / California</option>
										<option>Bangladesh</option>
										<option>Inglaterra</option>
										<option>India</option>
										<option>Pakistan</option>
					...
					<div class="col-sm-4">
						<div class="order-message">
							...
							<label><input type="checkbox"> Enviar a la direccion de compra</label>
						</div>	
					</div>					
				</div>
			</div>
